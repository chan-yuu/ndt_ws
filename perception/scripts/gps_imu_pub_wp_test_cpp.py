...
def publish_data():
    ...
    while not rospy.is_shutdown():
        ...
        if message.arbitration_id == 0x10B:
            ...
            GPS_MSG.posX = from_latlon(GPS_MSG.PosLat, GPS_MSG.PosLon)[0] - 520000
            GPS_MSG.posY = from_latlon(GPS_MSG.PosLat, GPS_MSG.PosLon)[1] - 4200000
            ## 暂时使用：
